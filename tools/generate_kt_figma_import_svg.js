...
<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <g filter="url(#shadow)">
    ...
    ${flowNode(622, 210, 236, 176, "执行层 ACT", ["12V 水泵 + 单路继电器", "WS2812 11 灯珠湿度温度计", "温度异常跳过浇水", "限频、限时、防抖"], "能动作，也能自我约束", "#EAF6DF", "#639922", "#27500A")}
  ...
  <g filter="url(#shadow)">
    ...
    ${miniCard(324, 480, 246, 54, "8 种作物参数库", "叶菜 4 + 果菜 4，3 位拨码即切即用。", colors.green)}
    ...
    ${sectionTitle(630, 458, "作物数据库与策略", "8 种作物：叶菜 4 + 果菜 4")}
    ...
    ${block(725, 525, "生菜、小白菜、菠菜、韭菜", { size: 12.5, line: 18, weight: 550, fill: "#49322A", maxChars: 18 })}
    ...
    ${block(725, 562, "番茄、辣椒、黄瓜、茄子", { size: 12.5, line: 18, weight: 550, fill: "#49322A", maxChars: 18 })}
    ...
    ${block(725, 599, "", { size: 12.5, line: 18, weight: 550, fill: "#49322A", maxChars: 18 })}
